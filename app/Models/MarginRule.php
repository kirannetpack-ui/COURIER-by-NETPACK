...
class MarginRule extends Model
{
    ...
    {
        $type = $this->margin_type === 'percentage' ? $this->margin_value . '%' : '$' . number_format($this->margin_value, 2);
        $weight = $this->weight_to ? $this->weight_from . ' - ' . $this->weight_to . ' kg' : $this->weight_from . '+ kg';
