...
<div class="max-w-4xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm">
        <div class="px-6 py-4 border-b">
            ...
            <p class="text-sm text-gray-500 mt-1">Update overseas partner information</p>
        </div>

        <div class="p-6">
            <form method="POST" action="{{ route('international.partners.update', $partner->id) }}">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        <h3 class="text-lg font-semibold text-gray-700 mb-3 border-b pb-2">Company Information</h3>
                    </div>

                    <div>
                        <label class="block text-sm font-medium mb-1">Company Name *</label>
                        <input type="text" name="company_name" value="{{ old('company_name', $partner->company_name) }}" 
                    ...
                    <!-- Contact Information -->
                    <div class="md:col-span-2">
                        <h3 class="text-lg font-semibold text-gray-700 mt-4 mb-3 border-b pb-2">Contact Information</h3>
                    </div>
                    ...
                    <!-- Account Status -->
                    <div class="md:col-span-2">
                        <h3 class="text-lg font-semibold text-gray-700 mt-4 mb-3 border-b pb-2">Account Status</h3>
                    </div>
                    ...
                    <!-- Password Update -->
                    <div class="md:col-span-2">
                        <h3 class="text-lg font-semibold text-gray-700 mt-4 mb-3 border-b pb-2">Update Password (Optional)</h3>
                    </div>
