    ...
    <div class="bg-white rounded-xl shadow-sm">
        <div class="px-6 py-4 border-b flex justify-between items-center">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">View overseas partner information</p>
            </div>
            <div class="flex gap-2">
                ...
                <a href="{{ route('international.partners') }}" class="bg-gray-300 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-400">
                    Back
                </a>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="border rounded-lg p-4">
                    ...
                    <p class="font-medium">
                        ...
                        @else
                            <span class="text-red-600">{{ ucfirst($partner->verification_status) }}</span>
                        @endif
                    </p>
                </div>
                @if($partner->address)
                ...
                <div class="border rounded-lg p-4">
                    ...
                    <p class="font-medium">${{ number_format($stats['total_revenue'] ?? 0, 2) }}</p>
                </div>
                <div class="border rounded-lg p-4">
