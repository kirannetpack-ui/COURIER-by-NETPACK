                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" rows="3" 
                                  class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500">{{ old('description', $product->description) }}</textarea>
                    </div>
                    ...
                    <div>
                        ...
                        <select name="category" required class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500">
                            ...
                            <option value="Utilities" {{ old('category', $product->category) === 'Utilities' ? 'selected' : '' }}>🔧 Utilities</option>
                    ...
                    <div>
                        ...
                        <input type="number" name="price_npr" step="0.01" value="{{ old('price_npr', $product->price_npr) }}" required 
                               class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-teal-500">
                    </div>
