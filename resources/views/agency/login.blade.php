...
<head>
    ...
    <title>Agency Login - NETPACK</title>
    ...
    <div class="min-h-screen flex items-center justify-center">
        <div class="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full mx-4">
            <div class="text-center mb-6">
                <i class="fas fa-building text-teal-600 text-5xl mb-3"></i>
                <h1 class="text-2xl font-bold">Agency Portal</h1>
                <p class="text-gray-500">Login to manage shipments</p>
            </div>
